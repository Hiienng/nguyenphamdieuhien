...
3. Đọc `.claude/infrastructure_changelog.md` — nếu có entry, merge vào `system_context.md` rồi xóa sạch
...
- Đọc `.claude/knowledge/Vn-Compliant-E2E-Data-Flow.md` để đối chiếu Compliance Status Tracker
...
- Đọc `.claude/knowledge/data-flow-handbook.md` — đối chiếu Threshold Table với số sellers hiện tại
...
Sau khi audit, cập nhật bảng **Compliance Status Tracker** trong `Vn-Compliant-E2E-Data-Flow.md` — đổi status của những hạng mục đã hoàn thành hoặc phát hiện vấn đề mới.
